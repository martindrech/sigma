...
plt.clf()
plt.plot(temp, dispX, 'b', label = 'dispX', linewidth = 2)
plt.plot(temp, dispP, 'r',label = 'dispP', linewidth = 2)
plt.plot(au_T, au_dispX, 'ob', label = 'au_dispX') 
plt.plot(au_T, au_dispP, 'or', label = 'au_dispP')
